...
public class SecureChar {
	...
	public static String SECURITY_ENCRYPTION_FORMAT = "utf-8";
	
public static String encode(String val){
		
		try{
		// encode with padding
		String encoded = Base64.getEncoder().encodeToString(val.getBytes(SECURITY_ENCRYPTION_FORMAT));
		// encode without padding
		//String encoded = Base64.getEncoder().withoutPadding().encodeToString(val.getBytes(SECURITY_ENCRYPTION_FORMAT));
	...
	public static String decode(String val){
		try{
			...
			return new String(barr,SECURITY_ENCRYPTION_FORMAT);
			}catch(Exception e){}
			return null;
	}
